...
import { Download, Search, TrendingUp, TrendingDown, Users, Eye, Play, Gift, DollarSign, Crown, Zap, ChevronDown, ChevronUp, X, DollarSign as DollarIcon, Filter as FilterIcon } from 'lucide-react';
            ...
            <div className="flex items-center justify-between mb-2 md:mb-3">
              ...
              <div className="flex flex-col items-end gap-2 w-full sm:w-auto ml-auto mr-2">
                <button
                  ...
                  className={`flex items-center justify-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 text-xs sm:text-sm border
                    ${showAdvancedFilters 
                ...
                <button
                  ...
                  className="flex items-center justify-center space-x-2 px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white/80 hover:text-white hover:bg-white/20 transition-all duration-200 text-xs sm:text-sm"
                >
              ...
              {filteredTransactions.length === 0 ? (
                ...
                displayedTransactions.map((tx, index) => (
                  <div key={tx.id} className="relative">
                    <motion.div
                      className={`flex items-center justify-between p-4 bg-white/10 border border-white/20 rounded-2xl shadow-xl backdrop-blur-lg hover:scale-[1.02] transition-all duration-200 ${
